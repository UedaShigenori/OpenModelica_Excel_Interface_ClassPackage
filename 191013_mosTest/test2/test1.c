...
#define _OMC_LIT_RESOURCE_0_dir_data "C:/Work/CAE/Modelica/OpenModelica/OpenModelica_Excel_Interface_ClassPackage/191013_mosTest/test2"
...
void test1_setupDataStruc(DATA *data, threadData_t *threadData)
{
  ...
  data->modelData->modelDir = "C:/Work/CAE/Modelica/OpenModelica/OpenModelica_Excel_Interface_ClassPackage/191013_mosTest/test2";
  data->modelData->modelGUID = "{8367e0b8-64b1-48d1-9342-9a22c9df9140}";
