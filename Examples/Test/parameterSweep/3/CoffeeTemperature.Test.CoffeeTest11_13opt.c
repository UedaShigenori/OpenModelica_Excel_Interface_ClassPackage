...
extern "C" {
#endif
int CoffeeTemperature_Test_CoffeeTest11_mayer(DATA* data, modelica_real** res,short *i) {
...
int CoffeeTemperature_Test_CoffeeTest11_lagrange(DATA* data, modelica_real** res, short * i1, short*i2) {
  throwStreamPrint(NULL, "The model was not compiled with -g=Optimica and the corresponding goal function. The optimization solver cannot be used.");
}
