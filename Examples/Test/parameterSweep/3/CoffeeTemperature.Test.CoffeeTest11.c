...
#define prefixedName_performSimulation CoffeeTemperature_Test_CoffeeTest11_performSimulation
#define prefixedName_updateContinuousSystem CoffeeTemperature_Test_CoffeeTest11_updateContinuousSystem
#include <simulation/solver/perform_simulation.c>

#define prefixedName_performQSSSimulation CoffeeTemperature_Test_CoffeeTest11_performQSSSimulation
...
int CoffeeTemperature_Test_CoffeeTest11_input_function(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
int CoffeeTemperature_Test_CoffeeTest11_input_function_init(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
int CoffeeTemperature_Test_CoffeeTest11_input_function_updateStartValues(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
int CoffeeTemperature_Test_CoffeeTest11_inputNames(DATA *data, char ** names){
  TRACE_PUSH
...
int CoffeeTemperature_Test_CoffeeTest11_output_function(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_650(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  ...
  RELATIONHYSTERESIS(tmp0, data->localData[0]->realVars[1] /* cup.medium.h STATE(1) */, data->localData[0]->realVars[30] /* $cse1.h variable */, 6, Less);
  RELATIONHYSTERESIS(tmp1, data->localData[0]->realVars[1] /* cup.medium.h STATE(1) */, data->localData[0]->realVars[130] /* $cse2.h variable */, 7, Greater);
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_651(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_652(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_653(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_654(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_655(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_656(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_657(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_658(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_659(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_660(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_661(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_662(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_663(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_664(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_665(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_666(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_667(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_668(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_669(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_670(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_671(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_672(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_673(DATA*,threadData_t*);
/*
 equation index: 674
 indexNonlinear: 10
 type: NONLINEAR
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_674(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_675(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_676(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_677(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_678(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_679(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,679};
  modelica_boolean tmp1;
  RELATIONHYSTERESIS(tmp1, data->localData[0]->realVars[0] /* cup.level STATE(1) */, data->simulationInfo->realParameter[34], 5, GreaterEq);
  data->localData[0]->booleanVars[7] /* cup.regularFlow[1] DISCRETE */ = tmp1;
  TRACE_POP
}
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_680(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_681(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_682(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_683(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_684(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_685(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_686(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_687(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_688(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_689(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_690(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_691(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_692(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_693(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_694(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_695(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_696(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_697(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_698(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_699(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_700(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_701(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_702(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_703(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_704(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_705(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_706(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_707(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_708(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_709(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_710(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_711(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_712(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_713(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_714(DATA*,threadData_t*);
/*
 equation index: 715
 indexNonlinear: 11
 type: NONLINEAR
 ...
 eqns: {680, 681, 682, 683, 684, 685, 686, 687, 688, 689, 690, 691, 692, 693, 694, 695, 696, 697, 698, 699, 700, 701, 702, 703, 704, 705, 706, 707, 708, 709, 710, 711, 712, 713, 714}
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_715(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  ...
  if(ACTIVE_STREAM(LOG_DT))
  {
    infoStreamPrint(LOG_DT, 1, "Solving nonlinear system 715 (STRICT TEARING SET if tearing enabled) at time = %18.10e", data->localData[0]->timeValue);
    messageClose(LOG_DT);
  }
  /* get old value */
  data->simulationInfo->nonlinearSystemData[11].nlsxOld[0] = data->localData[0]->realVars[292] /* naturalConvection1.T variable */;
  retValue = solve_nonlinear_system(data, threadData, 11);
  /* check if solution process was successful */
  if (retValue > 0){
    const int indexes[2] = {1,715};
    throwStreamPrintWithEquationIndexes(threadData, indexes, "Solving non-linear system 715 failed at time=%.15g.\nFor more information please use -lv LOG_NLS.", data->localData[0]->timeValue);
  }
  /* write solution */
  data->localData[0]->realVars[292] /* naturalConvection1.T variable */ = data->simulationInfo->nonlinearSystemData[11].nlsx[0];
  TRACE_POP
}
/*
 equation index: 716
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_716(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_717(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_718(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_719(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_720(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_721(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_722(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_723(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_724(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_725(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_726(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_727(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_728(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_729(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_730(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_731(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_732(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_733(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_734(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_735(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_736(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_737(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_738(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_739(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_740(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_741(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_742(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_743(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_744(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_745(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_746(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_747(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_748(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_749(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_750(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_751(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_752(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_753(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_754(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_755(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_756(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_757(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_758(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_759(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_760(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_761(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_762(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_763(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_764(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_765(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_766(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_767(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_768(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_769(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_770(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_771(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_772(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_773(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_774(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_775(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_776(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_777(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_778(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_779(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_780(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_781(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_782(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_783(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_788(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_787(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_786(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_785(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_784(DATA*,threadData_t*);
/*
 equation index: 789
 indexNonlinear: 12
 type: NONLINEAR
 ...
 eqns: {764, 765, 766, 767, 768, 769, 770, 771, 772, 773, 774, 775, 776, 777, 778, 779, 780, 781, 782, 783, 788, 787, 786, 785, 784}
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_789(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  ...
  if(ACTIVE_STREAM(LOG_DT))
  {
    infoStreamPrint(LOG_DT, 1, "Solving nonlinear system 789 (STRICT TEARING SET if tearing enabled) at time = %18.10e", data->localData[0]->timeValue);
    messageClose(LOG_DT);
  }
  /* get old value */
  ...
  /* check if solution process was successful */
  if (retValue > 0){
    const int indexes[2] = {1,789};
    throwStreamPrintWithEquationIndexes(threadData, indexes, "Solving non-linear system 789 failed at time=%.15g.\nFor more information please use -lv LOG_NLS.", data->localData[0]->timeValue);
  }
  /* write solution */
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_790(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_791(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_792(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,792};
  modelica_boolean tmp0;
  tmp0 = Greater((-data->localData[0]->realVars[371] /* yakan.mb_flow variable */),0.0);
  data->localData[0]->realVars[258] /* cup.ports_H_flow[1] variable */ = ((-data->localData[0]->realVars[371] /* yakan.mb_flow variable */)) * ((tmp0?data->localData[0]->realVars[342] /* pipe.port_b.h_outflow variable */:data->localData[0]->realVars[1] /* cup.medium.h STATE(1) */));
  TRACE_POP
}
/*
 equation index: 793
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_794(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,794};
  modelica_boolean tmp2;
  tmp2 = Greater(data->localData[0]->realVars[371] /* yakan.mb_flow variable */,0.0);
  data->localData[0]->realVars[383] /* yakan.ports_H_flow[1] variable */ = (data->localData[0]->realVars[371] /* yakan.mb_flow variable */) * ((tmp2?data->localData[0]->realVars[341] /* pipe.port_a.h_outflow variable */:data->localData[0]->realVars[6] /* yakan.medium.h STATE(1) */));
  TRACE_POP
}
/*
 equation index: 795
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_795(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,795};
  modelica_real tmp3;
  tmp3 = data->localData[0]->realVars[381] /* yakan.portVelocities[1] variable */;
  data->localData[0]->realVars[382] /* yakan.ports_E_flow[1] variable */ = (data->localData[0]->realVars[371] /* yakan.mb_flow variable */) * ((0.5) * ((tmp3 * tmp3)) + (data->simulationInfo->realParameter[83]) * (data->simulationInfo->realParameter[146]));
  TRACE_POP
}
/*
 equation index: 796
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_796(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_797(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_798(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_799(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_800(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_802(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_801(DATA*,threadData_t*);
/*
 equation index: 803
 indexNonlinear: 13
 type: NONLINEAR
 ...
 eqns: {797, 798, 799, 800, 802, 801}
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_803(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_804(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_805(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_806(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_807(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_808(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_809(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_810(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_811(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_812(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_813(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_814(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_815(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,815};
  Modelica_Media_Common_IF97BaseTwoPhase tmp2;
  tmp2 = omc_Modelica_Media_Water_IF97__Utilities_waterBaseProp__ph(threadData, data->localData[0]->realVars[256] /* cup.ports[1].p variable */, data->localData[0]->realVars[342] /* pipe.port_b.h_outflow variable */, ((modelica_integer) 0), ((modelica_integer) 0));
  data->localData[0]->integerVars[6] /* $cse15.phase DISCRETE */ = tmp2._phase;
  data->localData[0]->integerVars[7] /* $cse15.region DISCRETE */ = tmp2._region;
  data->localData[0]->realVars[86] /* $cse15.p variable */ = tmp2._p;
  data->localData[0]->realVars[81] /* $cse15.T variable */ = tmp2._T;
  data->localData[0]->realVars[85] /* $cse15.h variable */ = tmp2._h;
  data->localData[0]->realVars[80] /* $cse15.R variable */ = tmp2._R;
  data->localData[0]->realVars[82] /* $cse15.cp variable */ = tmp2._cp;
  data->localData[0]->realVars[83] /* $cse15.cv variable */ = tmp2._cv;
  data->localData[0]->realVars[89] /* $cse15.rho variable */ = tmp2._rho;
  data->localData[0]->realVars[90] /* $cse15.s variable */ = tmp2._s;
  data->localData[0]->realVars[88] /* $cse15.pt variable */ = tmp2._pt;
  data->localData[0]->realVars[87] /* $cse15.pd variable */ = tmp2._pd;
  data->localData[0]->realVars[92] /* $cse15.vt variable */ = tmp2._vt;
  data->localData[0]->realVars[91] /* $cse15.vp variable */ = tmp2._vp;
  data->localData[0]->realVars[93] /* $cse15.x variable */ = tmp2._x;
  data->localData[0]->realVars[84] /* $cse15.dpT variable */ = tmp2._dpT;
  TRACE_POP
}
/*
 equation index: 816
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_816(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_818(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,818};
  modelica_real tmp4;
  tmp4 = data->localData[0]->realVars[255] /* cup.portVelocities[1] variable */;
  data->localData[0]->realVars[257] /* cup.ports_E_flow[1] variable */ = ((-data->localData[0]->realVars[371] /* yakan.mb_flow variable */)) * ((0.5) * ((tmp4 * tmp4)) + (data->simulationInfo->realParameter[83]) * (data->simulationInfo->realParameter[34]));
  TRACE_POP
}
/*
 equation index: 819
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_819(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_820(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_821(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_822(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_823(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_825(DATA*,threadData_t*);
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_824(DATA*,threadData_t*);
/*
 equation index: 826
 indexNonlinear: 14
 type: NONLINEAR
 ...
 eqns: {820, 821, 822, 823, 825, 824}
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_826(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_827(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_838(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_837(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_836(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_835(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_834(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_833(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_832(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_831(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_830(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_829(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
 ...
 */
void CoffeeTemperature_Test_CoffeeTest11_eqFunction_828(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
OMC_DISABLE_OPT
int CoffeeTemperature_Test_CoffeeTest11_functionDAE(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  ...
  CoffeeTemperature_Test_CoffeeTest11_functionLocalKnownVars(data, threadData);
  ...
  CoffeeTemperature_Test_CoffeeTest11_eqFunction_742(data, threadData);

  CoffeeTemperature_Test_CoffeeTest11_eqFunction_743(data, threadData);

  CoffeeTemperature_Test_CoffeeTest11_eqFunction_744(data, threadData);

  CoffeeTemperature_Test_CoffeeTest11_eqFunction_745(data, threadData);

  CoffeeTemperature_Test_CoffeeTest11_eqFunction_746(data, threadData);

  CoffeeTemperature_Test_CoffeeTest11_eqFunction_747(data, threadData);
  ...
  CoffeeTemperature_Test_CoffeeTest11_eqFunction_790(data, threadData);

  CoffeeTemperature_Test_CoffeeTest11_eqFunction_791(data, threadData);
  ...
  CoffeeTemperature_Test_CoffeeTest11_eqFunction_810(data, threadData);

  CoffeeTemperature_Test_CoffeeTest11_eqFunction_811(data, threadData);

  CoffeeTemperature_Test_CoffeeTest11_eqFunction_812(data, threadData);
  ...
  CoffeeTemperature_Test_CoffeeTest11_eqFunction_815(data, threadData);

  CoffeeTemperature_Test_CoffeeTest11_eqFunction_816(data, threadData);
  ...
  CoffeeTemperature_Test_CoffeeTest11_eqFunction_838(data, threadData);

  CoffeeTemperature_Test_CoffeeTest11_eqFunction_837(data, threadData);

  CoffeeTemperature_Test_CoffeeTest11_eqFunction_836(data, threadData);

  CoffeeTemperature_Test_CoffeeTest11_eqFunction_835(data, threadData);

  CoffeeTemperature_Test_CoffeeTest11_eqFunction_834(data, threadData);

  CoffeeTemperature_Test_CoffeeTest11_eqFunction_833(data, threadData);

  CoffeeTemperature_Test_CoffeeTest11_eqFunction_832(data, threadData);

  CoffeeTemperature_Test_CoffeeTest11_eqFunction_831(data, threadData);

  CoffeeTemperature_Test_CoffeeTest11_eqFunction_830(data, threadData);

  CoffeeTemperature_Test_CoffeeTest11_eqFunction_829(data, threadData);

  CoffeeTemperature_Test_CoffeeTest11_eqFunction_828(data, threadData);
...
int CoffeeTemperature_Test_CoffeeTest11_functionLocalKnownVars(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
int CoffeeTemperature_Test_CoffeeTest11_functionODE(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
#include "CoffeeTemperature.Test.CoffeeTest11_13opt.h"

struct OpenModelicaGeneratedFunctionCallbacks CoffeeTemperature_Test_CoffeeTest11_callback = {
   (int (*)(DATA *, threadData_t *, void *)) CoffeeTemperature_Test_CoffeeTest11_performSimulation,
   (int (*)(DATA *, threadData_t *, void *)) CoffeeTemperature_Test_CoffeeTest11_performQSSSimulation,
   CoffeeTemperature_Test_CoffeeTest11_updateContinuousSystem,
   CoffeeTemperature_Test_CoffeeTest11_callExternalObjectDestructors,
   CoffeeTemperature_Test_CoffeeTest11_initialNonLinearSystem,
   NULL,
   NULL,
   #if !defined(OMC_NO_STATESELECTION)
   CoffeeTemperature_Test_CoffeeTest11_initializeStateSets,
   #else
   NULL,
   #endif
   CoffeeTemperature_Test_CoffeeTest11_initializeDAEmodeData,
   CoffeeTemperature_Test_CoffeeTest11_functionODE,
   CoffeeTemperature_Test_CoffeeTest11_functionAlgebraics,
   CoffeeTemperature_Test_CoffeeTest11_functionDAE,
   CoffeeTemperature_Test_CoffeeTest11_functionLocalKnownVars,
   CoffeeTemperature_Test_CoffeeTest11_input_function,
   CoffeeTemperature_Test_CoffeeTest11_input_function_init,
   CoffeeTemperature_Test_CoffeeTest11_input_function_updateStartValues,
   CoffeeTemperature_Test_CoffeeTest11_output_function,
   CoffeeTemperature_Test_CoffeeTest11_function_storeDelayed,
   CoffeeTemperature_Test_CoffeeTest11_updateBoundVariableAttributes,
   CoffeeTemperature_Test_CoffeeTest11_functionInitialEquations,
   1, /* useHomotopy - 0: local homotopy (equidistant lambda), 1: global homotopy (equidistant lambda), 2: new global homotopy approach (adaptive lambda), 3: new local homotopy approach (adaptive lambda)*/
   CoffeeTemperature_Test_CoffeeTest11_functionInitialEquations_lambda0,
   CoffeeTemperature_Test_CoffeeTest11_functionRemovedInitialEquations,
   CoffeeTemperature_Test_CoffeeTest11_updateBoundParameters,
   CoffeeTemperature_Test_CoffeeTest11_checkForAsserts,
   CoffeeTemperature_Test_CoffeeTest11_function_ZeroCrossingsEquations,
   CoffeeTemperature_Test_CoffeeTest11_function_ZeroCrossings,
   CoffeeTemperature_Test_CoffeeTest11_function_updateRelations,
   CoffeeTemperature_Test_CoffeeTest11_zeroCrossingDescription,
   CoffeeTemperature_Test_CoffeeTest11_relationDescription,
   CoffeeTemperature_Test_CoffeeTest11_function_initSample,
   CoffeeTemperature_Test_CoffeeTest11_INDEX_JAC_A,
   CoffeeTemperature_Test_CoffeeTest11_INDEX_JAC_B,
   CoffeeTemperature_Test_CoffeeTest11_INDEX_JAC_C,
   CoffeeTemperature_Test_CoffeeTest11_INDEX_JAC_D,
   CoffeeTemperature_Test_CoffeeTest11_initialAnalyticJacobianA,
   CoffeeTemperature_Test_CoffeeTest11_initialAnalyticJacobianB,
   CoffeeTemperature_Test_CoffeeTest11_initialAnalyticJacobianC,
   CoffeeTemperature_Test_CoffeeTest11_initialAnalyticJacobianD,
   CoffeeTemperature_Test_CoffeeTest11_functionJacA_column,
   CoffeeTemperature_Test_CoffeeTest11_functionJacB_column,
   CoffeeTemperature_Test_CoffeeTest11_functionJacC_column,
   CoffeeTemperature_Test_CoffeeTest11_functionJacD_column,
   CoffeeTemperature_Test_CoffeeTest11_linear_model_frame,
   CoffeeTemperature_Test_CoffeeTest11_linear_model_datarecovery_frame,
   CoffeeTemperature_Test_CoffeeTest11_mayer,
   CoffeeTemperature_Test_CoffeeTest11_lagrange,
   CoffeeTemperature_Test_CoffeeTest11_pickUpBoundsForInputsInOptimization,
   CoffeeTemperature_Test_CoffeeTest11_setInputData,
   CoffeeTemperature_Test_CoffeeTest11_getTimeGrid,
   CoffeeTemperature_Test_CoffeeTest11_symbolicInlineSystem,
   CoffeeTemperature_Test_CoffeeTest11_function_initSynchronous,
   CoffeeTemperature_Test_CoffeeTest11_function_updateSynchronous,
   CoffeeTemperature_Test_CoffeeTest11_function_equationsSynchronous,
   CoffeeTemperature_Test_CoffeeTest11_inputNames,
   NULL,
   NULL,
   NULL,
   -1
...
#define _OMC_LIT_RESOURCE_0_dir_data "C:/Work/CAE/Modelica/OpenModelica/OpenModelica_Excel_Interface_ClassPackage/Examples/Test/parameterSweep/3"
...
void CoffeeTemperature_Test_CoffeeTest11_setupDataStruc(DATA *data, threadData_t *threadData)
{
  assertStreamPrint(threadData,0!=data, "Error while initialize Data");
  threadData->localRoots[LOCAL_ROOT_SIMULATION_DATA] = data;
  data->callback = &CoffeeTemperature_Test_CoffeeTest11_callback;
  OpenModelica_updateUriMapping(threadData, MMC_REFSTRUCTLIT(_OMC_LIT_RESOURCES));
  data->modelData->modelName = "CoffeeTemperature.Test.CoffeeTest11";
  data->modelData->modelFilePrefix = "CoffeeTemperature.Test.CoffeeTest11";
  data->modelData->resultFileName = NULL;
  data->modelData->modelDir = "C:/Work/CAE/Modelica/OpenModelica/OpenModelica_Excel_Interface_ClassPackage/Examples/Test/parameterSweep/3";
  data->modelData->modelGUID = "{2e99ecda-5e06-4273-8dbe-e82fff28e8c9}";
  ...
  static const char contents_init[] =
    #include "CoffeeTemperature.Test.CoffeeTest11_init.c"
    ;
  static const char contents_info[] =
    #include "CoffeeTemperature.Test.CoffeeTest11_info.c"
    ;
  ...
  data->modelData->modelDataXml.fileName = "CoffeeTemperature.Test.CoffeeTest11_info.json";
...
int main(int argc, char**argv)
{
  ...
  omc_alloc_interface.init();
  {
    ...
    CoffeeTemperature_Test_CoffeeTest11_setupDataStruc(&data, threadData);
