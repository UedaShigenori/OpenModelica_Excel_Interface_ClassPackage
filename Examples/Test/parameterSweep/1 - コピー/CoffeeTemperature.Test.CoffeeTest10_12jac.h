...
extern "C" {
#endif
  #define CoffeeTemperature_Test_CoffeeTest10_INDEX_JAC_NLSJac7 0
  int CoffeeTemperature_Test_CoffeeTest10_functionJacNLSJac7_column(void* data, threadData_t *threadData);
  int CoffeeTemperature_Test_CoffeeTest10_initialAnalyticJacobianNLSJac7(void* data, threadData_t *threadData);
#if defined(__cplusplus)
}
#endif
/* NLSJac7 */
...
extern "C" {
#endif
  #define CoffeeTemperature_Test_CoffeeTest10_INDEX_JAC_D 1
  int CoffeeTemperature_Test_CoffeeTest10_functionJacD_column(void* data, threadData_t *threadData);
  int CoffeeTemperature_Test_CoffeeTest10_initialAnalyticJacobianD(void* data, threadData_t *threadData);
#if defined(__cplusplus)
}
#endif
/* D */
...
extern "C" {
#endif
  #define CoffeeTemperature_Test_CoffeeTest10_INDEX_JAC_C 2
  int CoffeeTemperature_Test_CoffeeTest10_functionJacC_column(void* data, threadData_t *threadData);
  int CoffeeTemperature_Test_CoffeeTest10_initialAnalyticJacobianC(void* data, threadData_t *threadData);
#if defined(__cplusplus)
}
#endif
/* C */
...
extern "C" {
#endif
  #define CoffeeTemperature_Test_CoffeeTest10_INDEX_JAC_B 3
  int CoffeeTemperature_Test_CoffeeTest10_functionJacB_column(void* data, threadData_t *threadData);
  int CoffeeTemperature_Test_CoffeeTest10_initialAnalyticJacobianB(void* data, threadData_t *threadData);
#if defined(__cplusplus)
}
#endif
/* B */
...
extern "C" {
#endif
  #define CoffeeTemperature_Test_CoffeeTest10_INDEX_JAC_A 4
  int CoffeeTemperature_Test_CoffeeTest10_functionJacA_column(void* data, threadData_t *threadData);
  int CoffeeTemperature_Test_CoffeeTest10_initialAnalyticJacobianA(void* data, threadData_t *threadData);
#if defined(__cplusplus)
}
#endif
/* A */
