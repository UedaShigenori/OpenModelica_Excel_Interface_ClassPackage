...
#define _OMC_LIT_RESOURCE_0_dir_data "C:/Work/CAE/Modelica/OpenModelica/OpenModelica_Excel_Interface_ClassPackage/Examples/Test/parameterSweep/4"
...
void test1_setupDataStruc(DATA *data, threadData_t *threadData)
{
  ...
  data->modelData->modelDir = "C:/Work/CAE/Modelica/OpenModelica/OpenModelica_Excel_Interface_ClassPackage/Examples/Test/parameterSweep/4";
  data->modelData->modelGUID = "{203764d1-f720-4a88-aede-0b1688421bc5}";
