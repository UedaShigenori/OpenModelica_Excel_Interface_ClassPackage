...
#define _OMC_LIT_RESOURCE_3_name_data "test1"
#define _OMC_LIT_RESOURCE_3_dir_data "C:/Work/CAE/Modelica/OpenModelica/OpenModelica_Excel_Interface_ClassPackage/Examples/1"
...
void test1_setupDataStruc(DATA *data, threadData_t *threadData)
{
  ...
  data->modelData->modelDir = "C:/Work/CAE/Modelica/OpenModelica/OpenModelica_Excel_Interface_ClassPackage/Examples/1";
  data->modelData->modelGUID = "{1233ce2f-a5be-4554-a1cc-058fcbcf74cd}";
